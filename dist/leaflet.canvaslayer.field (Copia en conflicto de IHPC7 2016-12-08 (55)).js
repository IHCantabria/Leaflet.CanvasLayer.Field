...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Field = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Field.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var _VectorField = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./VectorField.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Field2 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Field\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	        ...
	        value: function _completePyramidWithValues(pyramidLevel, params) {
	            ...
	            for (var j = 0; j < this.nRows; j++) {
	                for (var i = 0; i < this.nCols; i++) {
	                    var c = this._getCellFor(lon, lat, this.valueAt);
	                    cells.push(c); // <<
	                    lon += cellSize;
	                }
	                lat -= cellSize;
