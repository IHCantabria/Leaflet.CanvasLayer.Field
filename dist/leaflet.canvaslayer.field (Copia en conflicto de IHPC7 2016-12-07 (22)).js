...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = function () {
	    ...
	    _createClass(Field, [{
	        ...
	        /**
	         * Check the indexes are inside the field, adjusting to min or max when needed
	         * @private
	        ...
	        value: function _adjustToBordersIfNeeded(i, j) {
	            // i
	            if (i < 0) i = 0;
