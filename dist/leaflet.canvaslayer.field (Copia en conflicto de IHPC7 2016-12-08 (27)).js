	...
	var Field = function () {
	    ...
	    _createClass(Field, [{
	        ...
	        value: function interpolatedValueAt(lon, lat) {
	            ...
	            var _getDecimalIndexes2 = this._getDecimalIndexes();
	            ...
	            var _getFourSurroundingIn = this._getFourSurroundingIndexes();

	            var _getFourSurroundingIn2 = _slicedToArray(_getFourSurroundingIn, 4);

	            var fi = _getFourSurroundingIn2[0];
	            var ci = _getFourSurroundingIn2[1];
	            var fj = _getFourSurroundingIn2[2];
	            var cj = _getFourSurroundingIn2[3];
	        ...
	        /**
	         * Get surrounding indexes, clampling on borders
	         * @private
